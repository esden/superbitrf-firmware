...
/* USB D+ pullup defines. */
#define USB_PU_DIRECT
#define USB_PU_CLOCK RCC_APB2ENR_IOAEN
...
int main(void)
{
	...
	/* Setup GPIOA Pin 8 no pullup on D+ making it float, untill we are
